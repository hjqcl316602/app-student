  ...
  export default {
    ...
    methods: {
      async _init_page(){
        ...
        await this.$get_class_type_list();
      ...
      _save_class(){
        ...
        if(bool == 'yes'){
          this.$dialog.confirm({
            ...
            this.$add_class(this.params).then((data)=>{
    ...
    <van-popup position="bottom" v-model="popups[4]">
      <div class="vc-fluid vc-bg vc-flex vc-items--center">
        <div class="vc-fluid--w vc-padding__lg--ad">
          ...
          <div class="vp-btn__submit vp-btn--theme" @click="popups[4] = false">确认</div>
        </div>
      </div>
    </van-popup>

    <VaPopupRadio :options="options.sex" position="right" v-model="popups[5]" @select="_select_radio($event,'sex')"></VaPopupRadio>

    <VaPopupRadio :options="parentTypeList" position="right" v-model="popups[6]" @select="_select_radio($event,'parent')"></VaPopupRadio>

   <!-- <van-popup position="bottom" v-model="popups[6]">
      <div class="vc-fluid vc-bg vc-flex vc-items&#45;&#45;center">
        <div class="vc-fluid&#45;&#45;w vc-padding__lg&#45;&#45;ad">
          <div class="vp-input vc-margin&#45;&#45;bm">
            <input type="text" v-model="params.chengHu" placeholder="请输入孩子对您的称呼" class="vp-input__inner">
          </div>
          <div class="vp-btn__submit vp-btn&#45;&#45;theme" @click="popups[6] = false">返回</div>
        </div>
      </div>
    </van-popup>-->
    ...
    <div class="vc-bg">
      ...
      <div class="vp-row  vc-border--bm  vc-flex vc-items--center vc-content--between vc-padding__lg--ad" @click="popups[0] = true">
        <div class="vc-text--bold ">省市区</div>
      ...
      <div class="vp-row  vc-border--bm  vc-flex vc-items--center vc-content--between vc-padding__lg--ad" @click="popups[4] = true ">
        <div class="vc-text--bold "><span class="vc-text--danger">*</span>孩子姓名</div>
        <div class="vp-icon__outer">
          <span class=" vc-text vc-text--gray " v-if="!params.childName">请输入孩子的姓名</span>
          <span class=" vc-text vc-text--light " v-if="!!params.childName">{{ params.childName }}</span>
          <i class=" vc-text iconfont icon-iconfontjiantou2  vc-text--gray vc-margin__sm--lt"></i>
        </div>
      </div>
      ...
      <div class="vp-row  vc-border--bm  vc-flex vc-items--center vc-content--between vc-padding__lg--ad" @click="popups[5] = true ">
        ...
        <div class="vp-icon__outer">
          ...
          <span class=" vc-text vc-text--light " v-if="!!params.sexName">{{ params.sexName }}</span>
          <i class=" vc-text iconfont icon-iconfontjiantou2  vc-text--gray vc-margin__sm--lt"></i>
        </div>
      </div>

      <div   class="vp-row    vc-flex vc-items--center vc-content--between vc-padding__lg--ad" @click="popups[6] = true">
        <div class="vc-text--bold "><span class="vc-text--danger">*</span>孩子对您的称呼</div>
        <div class="vp-icon__outer">
          <span class=" vc-text vc-text--light " v-if="!!params.chengHu">{{ params.chengHu }}</span>
